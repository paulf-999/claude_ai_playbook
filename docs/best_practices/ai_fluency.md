...
|---|---|---|
| 🎯 **Delegation** | Deciding what work goes to AI vs human — matching tasks to the model's strengths and knowing when to stay in the loop | - [`process/session.md`](../../src/claude/process/session.md) (sub-agent selection)<br>- [`process/planning.md`](../../src/claude/process/planning.md) (plan mode gates)<br>- [`rules/cost_efficiency.md`](../../src/claude/rules/cost_efficiency.md) (sub-agent discipline) |
...
| 🔍 **Discernment** | Critically evaluating AI outputs for quality, accuracy, and completeness — not treating responses as ground truth | - [`rules/testing.md`](../../src/claude/rules/testing.md)<br>- [`process/session.md`](../../src/claude/process/session.md) (verification step after every change)<br>- [`process/planning.md`](../../src/claude/process/planning.md) (plan review before execution) |
