...
Rules governing Claude's general conduct and caution level.

| File | Purpose |
|------|---------|
| [`general.md`](general.md) | ⚠️ Default caution: ask before irreversible actions, investigate unexpected state, prefer simple approaches |
| [`risky_actions.md`](risky_actions.md) | 🚨 Explicit list of actions that always require user confirmation before proceeding |
