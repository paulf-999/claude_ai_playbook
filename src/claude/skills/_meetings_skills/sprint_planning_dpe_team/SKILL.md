...
If no page exists yet, offer to create one using the `data_platform_sprint_goals` pattern from `/confluence_create_page`.

**Publishing location for new pages:**
- Space: `DA` (space ID: `256213015`)
- Parent page: **DM - Sprint Goals 2026** (page ID: `5213847708`)

Publish the page as a child of `5213847708` — do not publish at the space root or under any other parent.
