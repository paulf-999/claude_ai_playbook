...
| [`payroc_engineering_naming_standards.md`](payroc_engineering_naming_standards.md) | 🏷️ Payroc company-wide engineering naming standards: segment codes, casing rules, repo naming pattern |
